package org.ncgr.intermine.bio.web;
...
public class FriendlyMineLinkController extends TilesAction {
    ...
    public ActionForward execute(ComponentContext context, ActionMapping mapping, ActionForm form,
        ...
        Collection<String> organismsInBag = BioUtil.getOrganisms(im.getObjectStore(), bag.getType(), bag.getContentsAsIds(), false, "shortName");
