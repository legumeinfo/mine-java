...
/**
 * Exports sequence.
 * Modified to include ConsensusRegion as a sequence-containing object.
 *
...
public class SequenceExportAction extends InterMineAction
{
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        if (obj instanceof SequenceFeature || obj instanceof Protein || obj instanceof ConsensusRegion) {
            ...
            PrintWriter out = response.getWriter();
            out.write("FASTA requested for an object that is not SequenceFeature, Protein or ConsensusRegion.");
            out.flush();
        }
